...
class LightColor {
  ...
  static const Color telkomBlue = Color(0xff00aac9);
  static const Color airtelRed = Color(0xffe8242d);
  static const Color safaricomGreen = Color(0xff0b9f3f);
  static const Color safaricomGreen2 = Color(0xff75c055);
  static const Color safaricomGreen3 = Color(0xffe21118);
